...
import com.ethan.floatmenudemo.floatball.runner.OnceRunnable;
import com.ethan.floatmenudemo.floatball.runner.ScrollRunner;
import com.ethan.floatmenudemo.floatball.utils.MotionVelocityUtil;
import com.ethan.floatmenudemo.floatball.utils.Util;
...
public class FloatBall extends FrameLayout implements ICarrier {
    ...
    private void init(Context context) {
        ...
        final int iconRes = mConfig.mIconRes;
        mSize = mConfig.mSize;
        Util.setBackground(imageView, iconRes);
